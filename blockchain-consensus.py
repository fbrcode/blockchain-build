...
class Blockchain(object):
    ...
    def valid_chain(self, chain):
        # responsible for checking if a chain is valid by looping through each block... 
    ...
    def resolve_conflicts(self):
        # loops through all our neighboring nodes, 
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Blockchain node with consensus')
